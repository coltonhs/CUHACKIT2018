...
{
	private string _username = "cuhackit2018-conversati-1520703205977";
	private string _password = "GG3Iz3wumwDZ";
	private string _url = "https://stream.watsonplatform.net/speech-to-text/api";
	private string _workspaceId = "6004b824-86da-488a-9d5f-81b129699b02";
