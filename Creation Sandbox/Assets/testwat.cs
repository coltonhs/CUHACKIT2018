...
public class testwat : MonoBehaviour
{
	...
	private string stt_username = "79c7c9c1-40d1-48e0-9ba9-f4f5f6de278a";
	private string stt_password = "iokUek7ZvnGV";
	// Change stt_url if different from below
	private string stt_url = "https://stream.watsonplatform.net/speech-to-text/api";

	private string convo_username = "b9486a89-6a02-4ed1-9272-a164e1f94971";
	private string convo_password = "GG3Iz3wumwDZ";
	...
	private string convo_workspaceId = "6004b824-86da-488a-9d5f-81b129699b03";
