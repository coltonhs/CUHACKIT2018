    ...
    public class VRTK_SimplePointer : VRTK_WorldPointer
    {
        ...
        protected override void Update()
        {
            ...
            if (pointer.gameObject.activeSelf)
            {
				...
				if (player.transform.position != (pointerCollidedWith.point)) {
					player.transform.position = Vector3.MoveTowards (player.transform.position, pointerCollidedWith.point, step);
					Debug.Log ("MOVE");
				}
